...
const models: TsoaRoute.Models = {
  ...
  GetUserListResponse: {
    ...
    properties: {
      ...
      users: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'UserInformationBrief' },
        required: true,
      },
    },
    additionalProperties: false,
  ...
  TeamInformationBrief: {
    ...
    properties: {
      ...
      seasonType: {
        dataType: 'union',
        subSchemas: [{ ref: 'SeasonType' }, { ref: 'ServiceSeasonType' }],
        required: true,
      },
      ...
      rootTeamSettings: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: {},
        additionalProperties: { ref: 'EnabledRootSettings' },
        required: true,
      },
      bindlePermissions: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: {},
        additionalProperties: { ref: 'EnabledBindlePermissions' },
        required: true,
      },
      parent: {
        dataType: 'union',
  ...
  GetTeamsForUsernameResponse: {
    ...
    properties: {
      teams: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'TeamInformationBrief' },
        required: true,
      },
    },
    additionalProperties: false,
  ...
  OrgChartNode: {
    ...
    properties: {
      ...
      type: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['ROOT_MEMBER'] },
          { dataType: 'enum', enums: ['DIVISION'] },
      ...
      attributes: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: {
          teamContext: { dataType: 'array', array: { dataType: 'string' } },
          email: { dataType: 'string' },
          role: { dataType: 'string' },
          description: { dataType: 'string' },
          friendlyName: { dataType: 'string' },
        },
  ...
  GetGroupInfoResponse: {
    ...
    properties: {
      ...
      subteams: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'GetGroupInfoResponse' },
        required: true,
      },
  ...
  GiteaHookCommitTrigger: {
    ...
    properties: {
      ...
      commits: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'GiteaCommit' },
        required: true,
      },
  ...
  JsonValue: {
    ...
    type: {
      dataType: 'union',
      subSchemas: [{ ref: 'JsonPrimitive' }, { ref: 'JsonObject' }, { ref: 'JsonArray' }],
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  ATSSubteamConfigRequest: {
    ...
    properties: {
      ...
      roleSpecificQuestions: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: {},
        additionalProperties: { dataType: 'array', array: { dataType: 'string' } },
        required: true,
      },
    },
    additionalProperties: false,
  ...
  ATSKanbanApplicationCard: {
    ...
    properties: {
      ...
      stars: {
        ...
        required: true,
        validators: {
          minimum: { errorMsg: 'Minimum Stars is 0', value: 0 },
          maximum: { errorMsg: 'Maximum Stars is 5', value: 5 },
        },
      },
    },
    additionalProperties: false,
    ...
    properties: {
      ...
      stageHistory: {
        ...
        array: {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            changedBy: { dataType: 'string' },
            changedAt: { dataType: 'datetime', required: true },
            stage: { ref: 'ApplicationStage', required: true },
          },
        },
      },
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    async function PlatformController_getPlatformLicense(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPlatformController_getPlatformLicense,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function BindleController_getDefinitions(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBindleController_getDefinitions,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getPeople(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getPeople,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getPersonInfo(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getPersonInfo,
          request,
          response,
        })
  ...
  app.get(
    '/api/org/people/:username/memberof',
    authenticateMiddleware([{ oidc: [] }]),
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...fetchMiddlewares<RequestHandler>(OrgController.prototype.getUserRootTeams),

    async function OrgController_getUserRootTeams(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getUserRootTeams,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_listRootTeamSettings(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_listRootTeamSettings,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getTeams(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getTeams,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getOrgChart(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getOrgChart,
          request,
          response,
        })
  ...
  app.get(
    '/api/org/orgchart/node/:teamId',
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...fetchMiddlewares<RequestHandler>(OrgController.prototype.getOrgChartNode),

    async function OrgController_getOrgChartNode(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getOrgChartNode,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getMyTeams(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getMyTeams,
          request,
          response,
        })
  ...
  app.post(
    '/api/org/teams/:teamId/externalinvite',
    ...
    async function OrgController_createInvite(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_createInvite,
          request,
          response,
        })
  ...
  app.get(
    '/api/org/people/avatar/upload-url',
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...fetchMiddlewares<RequestHandler>(OrgController.prototype.getAvatarUploadUrl),

    async function OrgController_getAvatarUploadUrl(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getAvatarUploadUrl,
          request,
          response,
        })
  ...
  app.get(
    '/api/org/people/avatar/download-url',
    authenticateMiddleware([{ oidc: [] }]),
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...fetchMiddlewares<RequestHandler>(OrgController.prototype.getAvatarDownloadUrl),

    async function OrgController_getAvatarDownloadUrl(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getAvatarDownloadUrl,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getInviteInfo(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getInviteInfo,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function OrgController_acceptInvite(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_acceptInvite,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function OrgController_verifySlack(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_verifySlack,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getTeamInfo(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getTeamInfo,
          request,
          response,
        })
  ...
  app.get(
    '/api/org/teams/:teamId/bindles',
    authenticateMiddleware([{ oidc: [] }]),
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...fetchMiddlewares<RequestHandler>(OrgController.prototype.getTeamBindles),

    async function OrgController_getTeamBindles(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getTeamBindles,
          request,
          response,
        })
  ...
  app.patch(
    ...
    async function OrgController_updateTeamBindles(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_updateTeamBindles,
          request,
          response,
        })
  ...
  app.get(
    '/api/org/teams/:teamId/awsaccess',
    ...
    async function OrgController_fetchAWSAccessCredentials(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_fetchAWSAccessCredentials,
          request,
          response,
        })
  ...
  app.patch(
    '/api/org/teams/:teamId/updateconf',
    ...
    async function OrgController_updateRootTeamSetting(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_updateRootTeamSetting,
          request,
          response,
        })
  ...
  app.post(
    '/api/org/teams/:teamId/addmember',
    authenticateMiddleware([{ bindles: ['corp:membermgmt'] }]),
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...fetchMiddlewares<RequestHandler>(OrgController.prototype.addTeamMember),

    async function OrgController_addTeamMember(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_addTeamMember,
          request,
          response,
        })
  ...
  const argsOrgController_removeTeamMember: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    body: {
      ...
      required: true,
      dataType: 'nestedObjectLiteral',
      nestedProperties: { userPk: { dataType: 'double', required: true } },
    },
  }
  app.post(
    '/api/org/teams/:teamId/removemember',
    authenticateMiddleware([{ bindles: ['corp:membermgmt'] }]),
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...fetchMiddlewares<RequestHandler>(OrgController.prototype.removeTeamMember),

    async function OrgController_removeTeamMember(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_removeTeamMember,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function OrgController_createSubTeam(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_createSubTeam,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function OrgController_getTeamCreationRequest(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_getTeamCreationRequest,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function OrgController_approveTeamCreationRequest(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_approveTeamCreationRequest,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function OrgController_declineTeamCreationRequest(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_declineTeamCreationRequest,
          request,
          response,
        })
  ...
  const argsOrgController_createTeam: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    createTeamReq: {
      ...
      name: 'createTeamReq',
      required: true,
      ref: 'APICreateTeamRequest',
    },
  }
  app.post(
    '/api/org/teams/create',
    authenticateMiddleware([{ oidc: [] }]),
    ...fetchMiddlewares<RequestHandler>(OrgController),
    ...
    async function OrgController_createTeam(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_createTeam,
          request,
          response,
        })
  ...
  app.patch(
    ...
    async function OrgController_syncOrgBindles(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_syncOrgBindles,
          request,
          response,
        })
  ...
  app.patch(
    ...
    async function OrgController_updateTeamAttributes(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_updateTeamAttributes,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function OrgController_deleteTeam(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrgController_deleteTeam,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function HooksController_processGitRepoEventHook(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHooksController_processGitRepoEventHook,
          request,
          response,
        })
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsHooksController_processGitMainCommitEventHook: Record<
    string,
  ...
  app.post(
    '/api/webhook/git/commitevent',
    ...fetchMiddlewares<RequestHandler>(HooksController),
    ...fetchMiddlewares<RequestHandler>(HooksController.prototype.processGitMainCommitEventHook),

    async function HooksController_processGitMainCommitEventHook(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHooksController_processGitMainCommitEventHook,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function AuthController_getUserInfo(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_getUserInfo,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function AuthController_handleLogin(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_handleLogin,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function AuthController_handleRedirect(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_handleRedirect,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function AuthController_otpInitRequest(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_otpInitRequest,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function AuthController_otpVerifyRequest(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_otpVerifyRequest,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function AuthController_otpVerifySession(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_otpVerifySession,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function AuthController_handleLogout(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_handleLogout,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ATSController_getResumeUploadUrl(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getResumeUploadUrl,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ATSController_getResumeDownloadUrl(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getResumeDownloadUrl,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ATSController_getSubTeamATSConfig(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getSubTeamATSConfig,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function ATSController_createOrUpdateSubteamConfig(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_createOrUpdateSubteamConfig,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ATSController_getAllRecruitingTeams(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getAllRecruitingTeams,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ATSController_getApplicationStages(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getApplicationStages,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ATSController_getTeamDetails(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getTeamDetails,
          request,
          response,
        })
  ...
  app.get(
    '/api/ats/applications/:teamId',
    authenticateMiddleware([{ bindles: ['corp:hiringaccess'] }]),
    ...fetchMiddlewares<RequestHandler>(ATSController),
    ...fetchMiddlewares<RequestHandler>(ATSController.prototype.getTeamApplications),

    async function ATSController_getTeamApplications(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getTeamApplications,
          request,
          response,
        })
  ...
  app.get(
    '/api/ats/applications/:teamId/:applicationId/info',
    authenticateMiddleware([{ bindles: ['corp:hiringaccess'] }]),
    ...fetchMiddlewares<RequestHandler>(ATSController),
    ...fetchMiddlewares<RequestHandler>(ATSController.prototype.getApplicationDetails),

    async function ATSController_getApplicationDetails(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getApplicationDetails,
          request,
          response,
        })
  ...
  const argsATSController_updateApplicationFeedback: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    body: {
      ...
      required: true,
      dataType: 'nestedObjectLiteral',
      nestedProperties: { notes: { dataType: 'string' }, stars: { dataType: 'double' } },
    },
  }
  app.put(
    '/api/ats/applications/:teamId/:applicationId/feedback',
    authenticateMiddleware([{ bindles: ['corp:hiringaccess'] }]),
    ...fetchMiddlewares<RequestHandler>(ATSController),
    ...fetchMiddlewares<RequestHandler>(ATSController.prototype.updateApplicationFeedback),

    async function ATSController_updateApplicationFeedback(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_updateApplicationFeedback,
          request,
          response,
        })
  ...
  app.get(
    '/api/ats/applications/:teamId/:applicantId/resume',
    authenticateMiddleware([{ bindles: ['corp:hiringaccess'] }]),
    ...fetchMiddlewares<RequestHandler>(ATSController),
    ...fetchMiddlewares<RequestHandler>(ATSController.prototype.getApplicantUrls),

    async function ATSController_getApplicantUrls(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getApplicantUrls,
          request,
          response,
        })
  ...
  app.put(
    '/api/ats/applications/:teamId/:applicationId/stage',
    authenticateMiddleware([{ oidc: [] }]),
    ...fetchMiddlewares<RequestHandler>(ATSController),
    ...fetchMiddlewares<RequestHandler>(ATSController.prototype.updateApplicationStage),

    async function ATSController_updateApplicationStage(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_updateApplicationStage,
          request,
          response,
        })
  ...
  app.get(
    '/api/ats/applications/:teamId/:applicantId/otherapps',
    authenticateMiddleware([{ bindles: ['corp:hiringaccess'] }]),
    ...fetchMiddlewares<RequestHandler>(ATSController),
    ...fetchMiddlewares<RequestHandler>(ATSController.prototype.getApplicantApplications),

    async function ATSController_getApplicantApplications(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_getApplicantApplications,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function ATSController_applyToTeam(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_applyToTeam,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function ATSController_updateProfile(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsATSController_updateProfile,
          request,
          response,
        })
