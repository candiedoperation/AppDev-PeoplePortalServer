...
export async function expressAuthentication(
    ...
    try {
        if (securityName == "oidc")
            ...
            /* Headless service-to-service scheme for AppDev Horizons (read-only analytics) */
            ...
            /* Digest both sides so timingSafeEqual gets equal-length buffers (it throws otherwise) */
